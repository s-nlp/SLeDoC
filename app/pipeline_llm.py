...
SYSTEM_PROMPT_RU = """Ты — юридический аналитик, который разбивает два сложных юридических параграфа на минимальные смысловые единицы и проводит соответствия между ними.
...
SYSTEM_PROMPT = """You are a legal analyst who breaks two complex legal paragraphs into minimal semantic units and establishes correspondences between them.
